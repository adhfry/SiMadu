...
const generateOutputMembership = () => {
  ...
  return { xValues, gradeC_minus, gradeC, gradeCPlus, gradeBMinus, gradeB, gradeBPlus, gradeAMinus, gradeA, gradeAPlus }
}

const { xValues, gradeC_minus, gradeC, gradeCPlus, gradeBMinus, gradeB, gradeBPlus, gradeAMinus, gradeA, gradeAPlus } = generateOutputMembership()
  ...
  <div class="output-chart-container">
    ...
    <div class="mt-2 grid grid-cols-3 sm:grid-cols-9 gap-1.5">
      <div class="bg-red-50 border border-red-300 rounded-lg p-1.5 text-center">
        ...
        <p class="text-sm font-bold text-red-700">{{ aggregation.C_minus.toFixed(3) }}</p>
      </div>
      <div class="bg-red-100 border border-red-400 rounded-lg p-1.5 text-center">
        <p class="text-[9px] text-gray-600">α C</p>
        <p class="text-sm font-bold text-red-800">{{ aggregation.C.toFixed(3) }}</p>
      </div>
      <div class="bg-orange-50 border border-orange-300 rounded-lg p-1.5 text-center">
        <p class="text-[9px] text-gray-600">α C+</p>
        <p class="text-sm font-bold text-orange-700">{{ aggregation.C_plus.toFixed(3) }}</p>
      </div>
      <div class="bg-yellow-50 border border-yellow-300 rounded-lg p-1.5 text-center">
        <p class="text-[9px] text-gray-600">α B-</p>
        <p class="text-sm font-bold text-yellow-700">{{ aggregation.B_minus.toFixed(3) }}</p>
      </div>
      <div class="bg-yellow-100 border border-yellow-400 rounded-lg p-1.5 text-center">
        <p class="text-[9px] text-gray-600">α B</p>
        <p class="text-sm font-bold text-yellow-800">{{ aggregation.B.toFixed(3) }}</p>
      </div>
      <div class="bg-blue-50 border border-blue-300 rounded-lg p-1.5 text-center">
        <p class="text-[9px] text-gray-600">α B+</p>
        <p class="text-sm font-bold text-blue-700">{{ aggregation.B_plus.toFixed(3) }}</p>
      </div>
      <div class="bg-cyan-50 border border-cyan-300 rounded-lg p-1.5 text-center">
        <p class="text-[9px] text-gray-600">α A-</p>
        <p class="text-sm font-bold text-cyan-700">{{ aggregation.A_minus.toFixed(3) }}</p>
      </div>
      <div class="bg-green-50 border border-green-300 rounded-lg p-1.5 text-center">
        <p class="text-[9px] text-gray-600">α A</p>
        <p class="text-sm font-bold text-green-700">{{ aggregation.A.toFixed(3) }}</p>
      </div>
      <div class="bg-green-100 border border-green-400 rounded-lg p-1.5 text-center">
        <p class="text-[9px] text-gray-600">α A+</p>
        <p class="text-sm font-bold text-green-800">{{ aggregation.A_plus.toFixed(3) }}</p>
      </div>
    </div>
  </div>
</template>
